...
<div class="pt-3 pb-3 subpage-full-details mydata svicmai_resultblk">
    <div class="container container-layout-two">
        <form id="quoteform" class="quteform super-visa-quote" action="{{ url('ajaxquotes') }}" method="POST">
            ...
            <div class="row wow slideInDown animated animated" data-wow-delay="100ms" data-wow-duration="1500ms"
                ...
                <div class="radiobtn input-group input-append col-md-3 col-sm-6 col-xs-12">
                    <input onchange="policytype(this.value)" type="radio" id="single" class="policy-type"
                        name="drone_policy" value="single" checked="">
                    <label for="single">Single Coverage</label>
                </div>
                <div class="radiobtn input-group input-append col-md-3 col-sm-6 col-xs-12">
                    <input onchange="policytype(this.value)" type="radio" id="couple" class="policy-type"
                        name="drone_policy" value="couple">
                    <label for="couple">Couple Policy</label>
                </div>
                @if ($data->url == 'visitor-insurance')
                    <div class="radiobtn input-group input-append col-md-3 col-sm-6 col-xs-12">
                        <input type="radio" id="family" class="policy-type" name="drone_policy" value="family"
                            data-gtm-form-interact-field-id="6"><label for="family">Family Policy</label>
                    </div>
                @endif
            </div>
            <div class="row wow slideInDown animated animated" id="first-dob" data-wow-delay="100ms"
                ...
                <div class="input-group input-append date col-md-4 col-sm-12 col-xs-12">
                    ...
                    <input onchange="getage(this.value)" type="text" class="form-control" id="date_of_birth_one"
                        name="years[]" placeholder="MM-DD-YYYY" autocomplete="off" readonly="true">
                ...
                <div class="input-group input-append date col-md-2">
                    <label>Age</label><input readonly type="number" placeholder="Age" class="card-number"
                        name="age" id="age">
                </div>
            </div>
            <div class="row" id="second-dob" style="display: none;">
                <div class="input-group input-append date col-md-4 col-sm-12 col-xs-12">
                    ...
                    <input onchange="getagesecondage(this.value)" type="text" class="form-control"
                        id="date_of_birth_two" placeholder="MM-DD-YYYY" name="years[]" autocomplete="off"
                        readonly="true">
                ...
                <div class="input-group input-append date col-md-2"> <label>Age</label><input type="number"
                        placeholder="Age" class="card-number" name="age_second" id="getagesecond"></div>
            </div>
            <div class="row wow slideInUp animated animated" id="days-calculate" data-wow-delay="100ms"
                data-wow-duration="1500ms"
                style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: slideInUp;">
                <div class="input-group input-append date col-md-4" id="datePicker_0">
                    ...
                    <input type="text" @if ($data->url != 'visitor-insurance') onchange="supervisayes()" @endif
                        @if ($data->url == 'visitor-insurance') onchange="visitorinsuracendate()" @endif class="form-control"
                        id="departure_date" name="departure_date" placeholder="MM-DD-YYYY" autocomplete="off"
                        readonly="true">
                ...
                <div class="input-group input-append date col-md-4">
                    ...
                    <input onchange="getnumberofdays()" type="text" class="form-control" name="return_date"
                        id="return_date" placeholder="MM-DD-YYYY" autocomplete="off" readonly="true">
                    <span class="input-group-addon add-on">
                ...
                <div class="input-group input-append date col-md-2">
                    <label>Days</label><input readonly type="number" placeholder="Days"
                        class="card-number visDaysNo" name="visDaysNo">
                </div>
            </div>
            <div class="row wow slideInUp animated animated mb-3" id="min-requirement" data-wow-delay="100ms"
                data-wow-duration="1500ms"
                style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: slideInUp;">
                <div class="input-group input-append date col-md-4">
                    ...
                    <select onchange="sum_insured(this.value)" name="sum_insured2" class="card-number">
                        ...
                        @foreach ($sum_insured as $key => $r)
                            <option @if ($key == 0) selected @endif value="{{ $r->sum_insured }}">
                                ${{ number_format($r->sum_insured) }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="row pre-existing-first wow slideInDown animated animated" data-wow-delay="100ms"
                data-wow-duration="1500ms"
                style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: slideInDown;">
                <div class="radiobtn col-md-2">
                    <input checked type="radio" id="no" class="pre-exist" name="pre_existing[]"
                        value="no">
                    <label for="no">No</label>
                </div>
                <div class="radiobtn col-md-2 ">
                    <input type="radio" id="yes" class="pre-exist" name="pre_existing[]"
            ...
            <div class="row pre-existing-second" style="display: none;">
                <div class="radiobtn col-md-2"><input type="radio" onchange="preexisitngtwofun(this.value)"
                        id="no-two" class="pre-exist" name="preexisitngtwo" value="no" checked=""><label
                        for="no-two">No</label> </div>
                <div class="radiobtn col-md-2 "><input type="radio" onchange="preexisitngtwofun(this.value)"
                        id="yes-two" class="pre-exist" name="preexisitngtwo" value="yes"><label
                        for="yes-two">Yes</label></div>
            </div>
            <div class="mt-3 form-group message-btn wow slideInUp animated animated" data-wow-delay="100ms"
                data-wow-duration="1500ms"
                style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: slideInUp;">
