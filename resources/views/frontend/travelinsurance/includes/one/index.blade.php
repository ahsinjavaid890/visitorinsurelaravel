...
?>
                ...
                <div class="listing-item" data-listing-price="<?php echo str_replace(',', '', number_format($total_price)); ?>">
                    <div class="coverage-amt coverage-amt-<?php echo $sum_insured; ?>"
                        style="line-height:1.0; display: <?php if ($request->sum_insured2 == $sum_insured) {
                            echo 'block';
                        } else {
                            echo 'none';
                        } ?>;">
                        <div class="row plan-details mb-0 ml-1 deductable-<?php echo $deductible; ?>"
                            style="display: <?php if ($deductible == '1000') {
                                ...
                                echo 'none';
                            } ?>; margin-top:0; margin-left:1px; margin-right:0; margin-bottom 0px !important;border-bottom: 1px solid #0084c1;">
                            ...
                            <div class="col-md-2 col-xs-6 text-center benefit_padding"
                                style="font-size: 18px;color: #333;">$<?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xs-6">
                                        <h1 style="padding: 0;margin: 0;line-height: normal; font-size:28px;">
                                            $<?php echo str_replace(',', '', number_format($total_price, 2)); ?></h1>
                                        <?php if($monthly_two == '1'){?>
                                        <h2
                                            style=" padding;5px; margin:0; font-size:14px; font-weight:bold;color: #333;font-family: arial;padding: 0;line-height: normal;margin-bottom: 10px;background: #F9F9F9;">
                                    ...
                                    <div class="col-md-6" style="padding-top: 10px;margin-bottom:10px;">
                                        ...
                                        <ul style="margin:0;">
                                            <li style="list-style: none;" class="hover_<?php echo $deductible . $plan_id; ?>"><a
                                                    href="#" class="mb-2"> Policy Details</a>

                                                <div class="row hoverdetails_<?php echo $deductible . $plan_id; ?>">
                                                    <div class="col-md-12">
                                                        <h2>Quote Details <?php echo $product_name; ?></h2>
                                                    </div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-12"
                                                            ...
                                                            <div class="col-md-12 no-padding"><span
                                                                    ...
                                                                    <span
                                                                        style="font-size:15px; color: #f5821f;"><?php echo $plan_name; ?>
                                                                        - <?php echo $plan_id; ?></span></span></div>
                                                            <div class="col-md-12 no-padding pt-1"><small
                                                                    style="font-size: 85% !important;">Days: <span
                                                                        style="color: #f5821f;"><?php echo $num_of_days; ?>
                                                                        (<?php echo $startdate; ?> -
                                                                        <?php echo $enddate; ?>)</span></small>
                                                                <small style="font-size: 85% !important;">Total: <span
                                                                        style="color: #f5821f;">$<?php echo number_format($total_price, 2); ?></span></small>
                                                            </div>
                                                            <div class="col-md-12 no-padding"><small
                                                                    style="font-size: 85% !important;">Option: <span
                                                                        style="color: #f5821f;">Deductible Option
                                                                        ($<?php echo $deductible; ?> (included in
                                                                        premium))</span></small></div>
                    ...
                    $per++;
                                        ?>
                                                                ...
                                                                <div class="col-md-12 no-padding"><small>Insured: <span
                                                                            ...
                                                                            <?php echo $person_age; ?>)</span> Coverage
                                                                        Amount: <span
                                                                            style="color: #f5821f;">$<?php echo $sum_insured; ?></span>
                                                                        Premium: <span
                                                                            style="color: #f5821f;">$<?php echo number_format($person_price, 2); ?></span></small>
                                                                </div>
                            ...
                            <div class="compare col-md-3 col-xs-12 text-center"><a
                                ...
                                <!--<small style="display:block"><strong>Plan Type: </strong> <?php if ($family_plan == 'yes') {
                                    echo '<i class="fa fa-child"></i> Family';
                                } else {
                                    echo '<i class="fa fa-user"></i> Individual';
                                } ?></small>-->
                            </div>
