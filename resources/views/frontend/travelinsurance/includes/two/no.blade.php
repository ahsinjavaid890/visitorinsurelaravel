...
<div class="row">
    <div class="compare col-md-2 hidden-xs mobile-displayflex" style="padding-top: 7px;margin: auto;">
        ...
        <img style="display: none;width: 50%;" width="100" class="mobile-deisply-show" src="https://lifeadvice.ca/public/images/{{ $second_comp_logo }}" />
    ...
    <div class="col-md-2 text-center mobile-deisply-none" style="padding-top: 0px;margin: auto;">
        <img width="200" class="img-thumbnail" src="https://lifeadvice.ca/public/images/{{ $second_comp_logo }}" />
    </div>
