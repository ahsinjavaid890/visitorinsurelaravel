...
<h2>$<?php echo $deductible; ?></h2>
                                ...
                                <div class="row" style="padding-bottom: 10px;">
                                    <div class="col-md-2 col-xs-6">
                                        <button type="button" class="btn btn-default dh-toggle"
                                            onclick="$('.moredetails_<?php echo $deductible . $plan_id; ?>').fadeToggle();"
    ...
    echo 'Individual';
...

                    {
                        ...
                        $person_price = $person_price - $p_discountonplan;
                            ...
                            <div class="row p-2 buynow_<?php echo $deductible . $plan_id; ?>"
                                style="clear:both;margin: 0;border: 1px solid #CCC; display:none;">
                                <div class="col-md-6 p-2" style="background:#F9F9F9;">
                                    <h3
