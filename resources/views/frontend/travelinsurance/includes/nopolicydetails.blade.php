        ...
        <div class="col-md-3">
            ...
            @if (in_array('yes', $second_a))
                @if ($second_plan->plan_pdf_pre_existing)
                    <a style=" font-size: 15px; margin-bottom: 15px; " href="https://lifeadvice.ca/public/images/{{ $second_plan->plan_pdf_pre_existing }}"
                ...
                @if ($second_plan->benifit_summary_pre_existing)
                    <a style=" font-size: 15px; margin-bottom: 15px; " href="https://lifeadvice.ca/public/images/{{ $second_plan->benifit_summary_pre_existing }}"
                        class="pdf-additional-travelers">
            ...
            @if (in_array('No', $second_a))
                ...
                @if ($second_plan->plan_pdf_without_pre_existing)
                    <a style=" font-size: 15px; margin-bottom: 15px; " href="https://lifeadvice.ca/public/images/{{ $second_plan->plan_pdf_without_pre_existing }}"
                        class="pdf-additional-travelers">
                ...
                @if ($second_plan->benifit_summary_without_pre_existing)
                    <a style=" font-size: 15px; margin-bottom: 15px; " href="https://lifeadvice.ca/public/images/{{ $second_plan->benifit_summary_without_pre_existing }}"
                        class="pdf-additional-travelers">
