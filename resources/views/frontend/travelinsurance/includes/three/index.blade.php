...
<div class="dh-listings " id="dh-get-quote">
    ...
    <div class="">
        <div class="row filterdiv hidden-xs"
            style="border: 1px solid #ddd;background: #F9F9F9;text-align: center;padding-top: 10px;border-top: 4px solid #DDD;">
...
?>
                ...
                <div class="desktop-compare listing-item" data-listing-price="<?php echo str_replace(',', '', number_format($total_price)); ?>">
                    <div class="coverage-amt coverage-amt-<?php echo $sum_insured; ?>" style=" display: <?php if ($request->sum_insured2 == $sum_insured) {
                        echo 'block';
                    } else {
                        echo 'none';
                    } ?>;">
                        <div class="row plan-details   deductable-<?php echo $deductible; ?>"
                            ...
                            <div class="col-md-4" style="padding-bottom: 10px; text-align:center;padding-left: 0;">
                                <img style="width:auto; max-height: 110px;"
                                ...
                                <div class="hover_<?php echo $deductible . $plan_id; ?>"><a href="#"
                                        style="display:block; padding:5px;color: #337ab7;"><i
                                            class="fa fa-info-circle"></i> Policy Details</a>
                                    <div class="row hoverdetails_<?php echo $deductible . $plan_id; ?>">
                                        <div class="col-md-12">
                                            <h2><strong>Quote Details <?php echo $product_name; ?></strong></h2>
                                        </div>
                                        <div class="col-md-12">
                                            <h3>Totel Premium: <span>$<?php echo number_format($total_price, 2); ?></span></h3>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-12"
                                                style="border:1px solid #333; text-align:left;font-size: 11px;">
                                                <div class="col-md-12 no-padding"><span
                                                        style="display:block; padding:3px; font-size:15px; text-align:left; border-bottom:1px dashed #333;">Plan:
                                                        <span
                                                            style="font-size:13px; color: #2ba382;"><?php echo $plan_name; ?></span></span>
                                                </div>
                                                <div class="col-md-12 no-padding"><small
                                                        style="    font-size: 90%;">Days: <span
                                                            style="color: #2ba382;"><?php echo $num_of_days; ?>
                                                            (<?php echo $startdate; ?> - <?php echo $enddate; ?>)</span></small>
                                                    <small style="    font-size: 90%;">Total: <span
                                                            style="color: #2ba382;">$<?php echo number_format($total_price, 2); ?></span></small>
                                                </div>
                                                <div class="col-md-12 no-padding"><small
                                                        style="    font-size: 90%;">Option: <span
                                                            style="color: #2ba382;">Deductible Option
                                                            ($<?php echo $deductible; ?> (included in premium))</span></small>
                                                </div>
                    ...
                    $per++;
                                        ?>
                                                    ...
                                                    if ($countarraytwo > 0) {
                                                        ...
                                                        if ($family_plan == 'yes' && $elder_age != $person_age) {
                                                            $person_daily = 0;
                                                        } elseif ($family_plan == 'yes' && $elder_age == $person_age) {
                                                    ...
                                                    ?>
                                                    <div class="col-md-12 no-padding"><span
                                                            style="display:block; padding:3px; font-size:15px; text-align:left; border-bottom:1px dashed #333;">Person
                                                            <?php echo $per; ?></span></div>
                                                    <div class="col-md-12 no-padding"><small
                                                            style="    font-size: 90%;">Insured: <span
                                                                style="color: #2ba382;"> (Age:
                                                                <?php echo $person_age; ?>)</span> Coverage Amount: <span
                                                                style="color: #2ba382;">$<?php echo $sum_insured; ?></span>
                                                            Premium: <span
                                                                style="color: #2ba382;">$<?php echo number_format($person_price, 2); ?></span></small>
                                                    </div>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                ...
                                <?php
                                $pdfq = DB::table('wp_dh_insurance_plans_pdfpolicies')
...
"><i class="fa fa-file-pdf-o pr-1" style="color:#fff;"></i> Sample Policy</a>  -->
            ...
            ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <strong><?php echo $feature->features; ?>
                                    </div></strong>
                            ...
                            <div class="col-md-3 text-center" style="padding-top: 30px; padding-bottom: 10px;">
                                <h1 class="planprice "><span class="text-center">Price</span> $<?php echo number_format($total_price, 2); ?>
                                </h1>
                                <p class="text-center" id="rate">This rate is for $<?php echo $deductible; ?>
                                    deductible options</p>
                                <div class="col-md-12 col-xs-12">
                                    ...
                                    ?>
                                    <a class="submit-btn" onclick="$('.buynow_<?php echo $deductible . $plan_id; ?>').fadeIn();"
                                        style="    font-weight: bold;padding: 7px 20px; box-shadow: none;border: 1px solid #999;  font-size: 16px;display: block;color: #FFF;background: #C00;border-radius: 5px;margin-top:2px;margin-bottom: 10px;}">
...
background: #F9F9F9; box-shadow: 0px 0px 1px 0px #CCC inset; border-radius: 3px; cursor:pointer;font-weight: bold;margin-bottom: 10px;" onclick="savecompareplans({{ $plan_id }},{{ $data->pro_id }},{{ $sum_insured }},{{ $deductible }},{{ $total_price }})"  style="cursor: pointer" class="col-md-12 col-xs-5" id="compare"><i class="fa fa-database"></i> Compare</label>
                            ...
                            <div class="row buynow_<?php echo $deductible . $plan_id; ?>"
                                style="clear: both;margin-left:0px; margin-right:0px;border: 1px solid rgb(204, 204, 204);background: #FFF;margin-top: 10px !important;margin-bottom: 10px !important; display:none;">
                                <form method="post" action="{{ url('apply') }}">
                                    ...
                                    <div class="row"
                                        style="clear:both;margin: 0;border: 1px solid #CCC; padding: 10px;">
                                        <div class="col-md-6" style="background:#F9F9F9;">
                                            ...
                                            <p><button type="submit" class="submit-btn"
                                                    style="font-weight: bold;padding: 7px 20px;box-shadow: none;border: 1px solid #999;font-size: 16px;display: block;color: #FFF;background: #2b3481;border-radius: 5px;margin-top: 2px; margin-bottom:10px;"><i
                                        ...
                                        <div class="col-md-6 text-center" style="font-size:16px;">
                                            ...
                                            <p
                                                ...
                                                CALL CENTRE HOURS</p>
                                            <p style="font-size:11px;line-height: normal;">Monday to Thursday 8:00 am
                                                to 9:00 pm EDT | Friday 8:00 am to 8:00 pm EDT | Saturday 8:30 am to
                                                4:00 pm EDT | Closed on holidays.</p>
                                        </div>
                                    </div>
                                </form>
                            </div>
