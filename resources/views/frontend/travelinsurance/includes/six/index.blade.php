                    ...
                    <div class="coverage-amt col-md-12 coverage-amt-<?php echo $sum_insured; ?>"
                        ...
                        <div class="row plan-details   deductable-<?php echo $deductible; ?>"
                            ...
                            <div class="col-md-1 col-xs-1 text-center" style="width: auto;padding: 20px 0px 0 10px;">
                                <a href="javascript:void(0)" class="dh-toggle"
                            ...
                            <div class="col-md-2 col-xs-8 text-center" style="padding: 5px 0px 0px 0;">
                                <h1 style="color:#223b74;font-size:32px; font-weight:bold;line-height: normal;">
                                    $<?php echo number_format($total_price, 2); ?></h1>
                            ...
                            <div class="col-md-1 col-xs-4" style="padding: 20px 0 0 0;">
                                <small style=" font-size: 10px; margin-left: 10px;"><?php echo $number_travelers; ?>
                                    traveller(s)</small>
                            </div>
                            <div class="col-md-3 col-xs-12 text-center"
                                style="font-size: 12px;color: #808180;padding-top: 5px;">
...
font-weight: bold;width: 100%; font-size: 16px; height: 42px;margin-top: 10px;"
                            ...
                            <div class="row buynow_<?php echo $deductible . $plan_id; ?>"
                                style="clear:both;margin: 0;border: 1px solid #CCC; display:none; margin-top:20px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" style="background:#F9F9F9; padding: 10px;">
                                            ...
                                            <p><button type="submit"
                                                    style="background-color: #2b3481; width: 100%; text-align: center; border: 0;"
                            ...
                            <div class="col-md-12 dh-toggle-show-hide-<?php echo $plan_id; ?>"
                                style="display:none; margin-top: 20px;border-top: 1px solid #ddd;font-family: arial;">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div style="font-size:12px;">
                                            ...
                                            <p style="margin:0;"><b>Plan Type:</b> <?php if ($family_plan == 'yes') {
                                                echo 'Family';
                                            } else {
                                                echo 'Individual';
                                            } ?></p>
                        ...
                        if($request->pre_existing[$per-1]=='yes')
                        {
                            ...
                            $existingshow = $without_pre_existing_name;
                                        ...
                                        echo number_format($person_price,2); ?>
                                            ...
                                            <p style="margin:0;"><b>Duration:</b> <?php echo $num_of_days; ?> days
                                                (<?php echo $startdate . ' - ' . $enddate; ?>)</p>
