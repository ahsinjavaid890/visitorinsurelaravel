        ...
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <div class="u-row"
              ...
              <div
                ...
                <div id="u_column_3" class="u-col u-col-33p33"
                  ...
                  <div
                    style="background-color: #12b48b;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;border-top-left-radius: 20px; border-top-right-radius: 20px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div class="v-col-border"
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-color v-text-align v-font-size"
                                ...
                                <p style="line-height: 140%;font-size: 28px;color: white;padding-top: 10px;">
            ...
            <div class="u-row"
              ...
              <div
                ...
                <div class="u-col u-col-100"
                  style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                  <div
                    style="background-color: #56beba;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div class="v-col-border"
                      style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                      <!--<![endif]-->
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-color v-text-align v-font-size"
                                style="color: white;margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; ">
                                <strong>
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-color v-text-align v-font-size"
                                style="color: white;margin: 0px; line-height: 140%; text-align: end; word-wrap: break-word; font-size: 16px; ">
                          ...
                          <tr>
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-color v-text-align v-font-size"
                                ...
                                @if($requesttype == 'refund') {{ Cmf::date_format($data->return_date) }} @else {{
                                Cmf::date_format($data->end_date) }} @endif
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row"
              style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
              <div class="u-row"
                style="color: #2b3481; background-color: #dae8e7;font-size: 28px;text-align: center;padding-top: 10px;font-family: 'Open Sans',sans-serif;">
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            ...
            <div class="u-row"
              ...
              <div class="u-row"
                style="color: #2b3481; background-color: #dae8e7;font-size: 30px;text-align: center;padding-top: 30px;font-family: 'Open Sans',sans-serif;">
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-text-align" align="center">
                                ...
                                <a href="" target="_blank" class="v-button v-size-width v-font-size"
                                  style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #12b48b; border-radius: 25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; width:35%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
