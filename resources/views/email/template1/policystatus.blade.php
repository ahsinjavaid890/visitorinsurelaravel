...
<img border="0" style="display:block;color:#000000;text-decoration:none;font-family:Helvetica,arial,sans-serif;font-size:16px;width: 40%;height: 100%;" width="200" alt="" src="{{ url('public/images') }}/{{ $settings->header_logo }}" height="41" class="CToWUd" data-bit="iit">
</td>
</tr>
</tbody>
</table>
