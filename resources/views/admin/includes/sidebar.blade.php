            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Manage Sales @if(DB::table('sales')->where('newstatus' , 'new')->where('website' , 'visitorinsure')->count() > 0) <span style="margin-left: 10px;" class="badge badge-danger">{{ DB::table('sales')->where('newstatus' , 'new')->where('website' , 'visitorinsure')->count() }}</span> @endif</span><i class="menu-arrow"></i>
                    </a>
